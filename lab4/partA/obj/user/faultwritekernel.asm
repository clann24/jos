...
libmain(int argc, char **argv)
{
  ...
  800056:	e8 11 01 00 00       	call   80016c <sys_getenvid>
...
sys_env_destroy(envid_t envid)
{
  ...
  800142:	00 
  800143:	c7 44 24 08 ca 11 80 	movl   $0x8011ca,0x8(%esp)
  80014a:	00 
  80014b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800152:	00 
  800153:	c7 04 24 e7 11 80 00 	movl   $0x8011e7,(%esp)
  80015a:	e8 e1 02 00 00       	call   800440 <_panic>
...
sys_getenvid(void)
{
  ...
  800175:	89 74 24 04          	mov    %esi,0x4(%esp)
  800179:	89 7c 24 08          	mov    %edi,0x8(%esp)
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
...
sys_getenvid(void)
{
  ...
  800194:	8b 74 24 04          	mov    0x4(%esp),%esi
  800198:	8b 7c 24 08          	mov    0x8(%esp),%edi
...
sys_yield(void)
{
  ...
  8001b6:	b8 0a 00 00 00       	mov    $0xa,%eax
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800209:	00 
  80020a:	c7 44 24 08 ca 11 80 	movl   $0x8011ca,0x8(%esp)
  800211:	00 
  800212:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800219:	00 
  80021a:	c7 04 24 e7 11 80 00 	movl   $0x8011e7,(%esp)
  800221:	e8 1a 02 00 00       	call   800440 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800267:	00 
  800268:	c7 44 24 08 ca 11 80 	movl   $0x8011ca,0x8(%esp)
  80026f:	00 
  800270:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800277:	00 
  800278:	c7 04 24 e7 11 80 00 	movl   $0x8011e7,(%esp)
  80027f:	e8 bc 01 00 00       	call   800440 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  8002c5:	00 
  8002c6:	c7 44 24 08 ca 11 80 	movl   $0x8011ca,0x8(%esp)
  8002cd:	00 
  8002ce:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002d5:	00 
  8002d6:	c7 04 24 e7 11 80 00 	movl   $0x8011e7,(%esp)
  8002dd:	e8 5e 01 00 00       	call   800440 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800323:	00 
  800324:	c7 44 24 08 ca 11 80 	movl   $0x8011ca,0x8(%esp)
  80032b:	00 
  80032c:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800333:	00 
  800334:	c7 04 24 e7 11 80 00 	movl   $0x8011e7,(%esp)
  80033b:	e8 00 01 00 00       	call   800440 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800381:	00 
  800382:	c7 44 24 08 ca 11 80 	movl   $0x8011ca,0x8(%esp)
  800389:	00 
  80038a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800391:	00 
  800392:	c7 04 24 e7 11 80 00 	movl   $0x8011e7,(%esp)
  800399:	e8 a2 00 00 00       	call   800440 <_panic>
...
sys_ipc_try_send(envid_t envid, uint32_t value, void *srcva, int perm)
{
  ...
  8003b8:	89 7c 24 08          	mov    %edi,0x8(%esp)
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
  ...
  8003c1:	b8 0b 00 00 00       	mov    $0xb,%eax
  8003c6:	8b 7d 14             	mov    0x14(%ebp),%edi
...
sys_ipc_try_send(envid_t envid, uint32_t value, void *srcva, int perm)
{
  ...
  8003d4:	8b 1c 24             	mov    (%esp),%ebx
  8003d7:	8b 74 24 04          	mov    0x4(%esp),%esi
  8003db:	8b 7c 24 08          	mov    0x8(%esp),%edi
  8003df:	89 ec                	mov    %ebp,%esp
  8003e1:	5d                   	pop    %ebp
  8003e2:	c3                   	ret    

008003e3 <sys_ipc_recv>:
...
sys_ipc_recv(void *dstva)
{
  ...
  8003e6:	83 ec 38             	sub    $0x38,%esp
  8003e9:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  8003ec:	89 75 f8             	mov    %esi,-0x8(%ebp)
  8003ef:	89 7d fc             	mov    %edi,-0x4(%ebp)
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
  ...
  8003f7:	b8 0c 00 00 00       	mov    $0xc,%eax
  ...
  800409:	7e 28                	jle    800433 <sys_ipc_recv+0x50>
		panic("syscall %d returned %d (> 0)", num, ret);
  80040b:	89 44 24 10          	mov    %eax,0x10(%esp)
  80040f:	c7 44 24 0c 0c 00 00 	movl   $0xc,0xc(%esp)
  800416:	00 
  800417:	c7 44 24 08 ca 11 80 	movl   $0x8011ca,0x8(%esp)
  80041e:	00 
  80041f:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800426:	00 
  800427:	c7 04 24 e7 11 80 00 	movl   $0x8011e7,(%esp)
  80042e:	e8 0d 00 00 00       	call   800440 <_panic>
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80044b:	8b 1d 00 20 80 00    	mov    0x802000,%ebx
  800451:	e8 16 fd ff ff       	call   80016c <sys_getenvid>
  ...
  80046c:	c7 04 24 f8 11 80 00 	movl   $0x8011f8,(%esp)
  800473:	e8 c3 00 00 00       	call   80053b <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800478:	89 74 24 04          	mov    %esi,0x4(%esp)
  80047c:	8b 45 10             	mov    0x10(%ebp),%eax
  80047f:	89 04 24             	mov    %eax,(%esp)
  800482:	e8 53 00 00 00       	call   8004da <vcprintf>
	cprintf("\n");
  800487:	c7 04 24 1c 12 80 00 	movl   $0x80121c,(%esp)
  80048e:	e8 a8 00 00 00       	call   80053b <cprintf>
...
putch(int ch, struct printbuf *b)
{
  ...
  8004ab:	83 c0 01             	add    $0x1,%eax
  8004ae:	89 03                	mov    %eax,(%ebx)
	if (b->idx == 256-1) {
  8004b0:	3d ff 00 00 00       	cmp    $0xff,%eax
  8004b5:	75 19                	jne    8004d0 <putch+0x38>
		sys_cputs(b->buf, b->idx);
  8004b7:	c7 44 24 04 ff 00 00 	movl   $0xff,0x4(%esp)
  8004be:	00 
  8004bf:	8d 43 08             	lea    0x8(%ebx),%eax
  8004c2:	89 04 24             	mov    %eax,(%esp)
  8004c5:	e8 de fb ff ff       	call   8000a8 <sys_cputs>
		b->idx = 0;
  8004ca:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
	}
	b->cnt++;
  8004d0:	83 43 04 01          	addl   $0x1,0x4(%ebx)
}
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  80050f:	c7 04 24 98 04 80 00 	movl   $0x800498,(%esp)
  800516:	e8 e6 01 00 00       	call   800701 <vprintfmt>
	sys_cputs(b.buf, b.idx);
  ...
  80052e:	e8 75 fb ff ff       	call   8000a8 <sys_cputs>

	return b.cnt;
}
  800533:	8b 85 f4 fe ff ff    	mov    -0x10c(%ebp),%eax
  800539:	c9                   	leave  
  80053a:	c3                   	ret    

	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800233:	0f be 80 29 0f 80 00 	movsbl 0x800f29(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80038b:	ff 24 85 b8 0f 80 00 	jmp    *0x800fb8(,%eax,4)
		case '6':
		case '7':
		case '8':
		case '9':
  ...
  800451:	c7 44 24 08 4a 0f 80 	movl   $0x800f4a,0x8(%esp)
  800458:	00 
  ...
  800486:	ba 3a 0f 80 00       	mov    $0x800f3a,%edx
...
sys_env_destroy(envid_t envid)
{
  ...
  800bde:	00 
  800bdf:	c7 44 24 08 2c 11 80 	movl   $0x80112c,0x8(%esp)
  800be6:	00 
  800be7:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800bee:	00 
  800bef:	c7 04 24 49 11 80 00 	movl   $0x801149,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800c68:	c7 04 24 58 11 80 00 	movl   $0x801158,(%esp)
  ...
  800c7e:	e8 5f f4 ff ff       	call   8000e2 <vcprintf>
	cprintf("\n");
  800c83:	c7 04 24 7c 11 80 00 	movl   $0x80117c,(%esp)

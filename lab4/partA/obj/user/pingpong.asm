...
umain(int argc, char **argv)
{
  ...
  80004b:	e8 78 0c 00 00       	call   800cc8 <sys_getenvid>
  800050:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  800054:	89 44 24 04          	mov    %eax,0x4(%esp)
  800058:	c7 04 24 40 13 80 00 	movl   $0x801340,(%esp)
  ...
  800082:	e8 7b 0f 00 00       	call   801002 <ipc_send>
	}
  ...
  8000e6:	e8 17 0f 00 00       	call   801002 <ipc_send>
		if (i == 10)
...
libmain(int argc, char **argv)
{
  ...
  80010a:	e8 b9 0b 00 00       	call   800cc8 <sys_getenvid>
...
exit(void)
{
  ...
  800155:	e8 11 0b 00 00       	call   800c6b <sys_env_destroy>
}
  80015a:	c9                   	leave  
  80015b:	c3                   	ret    
...
putch(int ch, struct printbuf *b)
{
  ...
  800189:	e8 76 0a 00 00       	call   800c04 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  8001da:	e8 e2 01 00 00       	call   8003c1 <vprintfmt>
	sys_cputs(b.buf, b.idx);
  ...
  8001f2:	e8 0d 0a 00 00       	call   800c04 <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80028f:	e8 3c 0e 00 00       	call   8010d0 <__udivdi3>
  ...
  8002ea:	e8 f1 0e 00 00       	call   8011e0 <__umoddi3>
  8002ef:	89 74 24 04          	mov    %esi,0x4(%esp)
  8002f3:	0f be 80 73 13 80 00 	movsbl 0x801373(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80044b:	ff 24 85 40 14 80 00 	jmp    *0x801440(,%eax,4)
		case '6':
		case '7':
		case '8':
		case '9':
  ...
  800511:	c7 44 24 08 94 13 80 	movl   $0x801394,0x8(%esp)
  800518:	00 
  ...
  800546:	ba 84 13 80 00       	mov    $0x801384,%edx
...
sys_env_destroy(envid_t envid)
{
  ...
  800c9e:	00 
  800c9f:	c7 44 24 08 c4 15 80 	movl   $0x8015c4,0x8(%esp)
  800ca6:	00 
  800ca7:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cae:	00 
  800caf:	c7 04 24 e1 15 80 00 	movl   $0x8015e1,(%esp)
  800cb6:	e8 b1 03 00 00       	call   80106c <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800d65:	00 
  800d66:	c7 44 24 08 c4 15 80 	movl   $0x8015c4,0x8(%esp)
  800d6d:	00 
  800d6e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d75:	00 
  800d76:	c7 04 24 e1 15 80 00 	movl   $0x8015e1,(%esp)
  800d7d:	e8 ea 02 00 00       	call   80106c <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800dc3:	00 
  800dc4:	c7 44 24 08 c4 15 80 	movl   $0x8015c4,0x8(%esp)
  800dcb:	00 
  800dcc:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800dd3:	00 
  800dd4:	c7 04 24 e1 15 80 00 	movl   $0x8015e1,(%esp)
  800ddb:	e8 8c 02 00 00       	call   80106c <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800e21:	00 
  800e22:	c7 44 24 08 c4 15 80 	movl   $0x8015c4,0x8(%esp)
  800e29:	00 
  800e2a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e31:	00 
  800e32:	c7 04 24 e1 15 80 00 	movl   $0x8015e1,(%esp)
  800e39:	e8 2e 02 00 00       	call   80106c <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800e7f:	00 
  800e80:	c7 44 24 08 c4 15 80 	movl   $0x8015c4,0x8(%esp)
  800e87:	00 
  800e88:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e8f:	00 
  800e90:	c7 04 24 e1 15 80 00 	movl   $0x8015e1,(%esp)
  800e97:	e8 d0 01 00 00       	call   80106c <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800edd:	00 
  800ede:	c7 44 24 08 c4 15 80 	movl   $0x8015c4,0x8(%esp)
  800ee5:	00 
  800ee6:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800eed:	00 
  800eee:	c7 04 24 e1 15 80 00 	movl   $0x8015e1,(%esp)
  800ef5:	e8 72 01 00 00       	call   80106c <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800f72:	00 
  800f73:	c7 44 24 08 c4 15 80 	movl   $0x8015c4,0x8(%esp)
  800f7a:	00 
  800f7b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800f82:	00 
  800f83:	c7 04 24 e1 15 80 00 	movl   $0x8015e1,(%esp)
  800f8a:	e8 dd 00 00 00       	call   80106c <_panic>
...
fork(void)
{
  ...
  800fa2:	c7 44 24 08 fb 15 80 	movl   $0x8015fb,0x8(%esp)
  800fa9:	00 
  800faa:	c7 44 24 04 52 00 00 	movl   $0x52,0x4(%esp)
  800fb1:	00 
  800fb2:	c7 04 24 ef 15 80 00 	movl   $0x8015ef,(%esp)
  800fb9:	e8 ae 00 00 00       	call   80106c <_panic>
...
sfork(void)
{
  ...
  800fc4:	c7 44 24 08 fa 15 80 	movl   $0x8015fa,0x8(%esp)
  800fcb:	00 
  800fcc:	c7 44 24 04 59 00 00 	movl   $0x59,0x4(%esp)
  800fd3:	00 
  800fd4:	c7 04 24 ef 15 80 00 	movl   $0x8015ef,(%esp)
  800fdb:	e8 8c 00 00 00       	call   80106c <_panic>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  800fe6:	c7 44 24 08 10 16 80 	movl   $0x801610,0x8(%esp)
  800fed:	00 
  800fee:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800ff5:	00 
  800ff6:	c7 04 24 29 16 80 00 	movl   $0x801629,(%esp)
  800ffd:	e8 6a 00 00 00       	call   80106c <_panic>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801008:	c7 44 24 08 33 16 80 	movl   $0x801633,0x8(%esp)
  80100f:	00 
  801010:	c7 44 24 04 2a 00 00 	movl   $0x2a,0x4(%esp)
  801017:	00 
  801018:	c7 04 24 29 16 80 00 	movl   $0x801629,(%esp)
  80101f:	e8 48 00 00 00       	call   80106c <_panic>

00801024 <ipc_find_env>:
...
ipc_find_env(enum EnvType type)
{
  ...
  80102a:	39 0d 50 00 c0 ee    	cmp    %ecx,0xeec00050
  801030:	74 17                	je     801049 <ipc_find_env+0x25>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  801032:	b8 01 00 00 00       	mov    $0x1,%eax
		if (envs[i].env_type == type)
  801037:	6b d0 7c             	imul   $0x7c,%eax,%edx
  80103a:	81 c2 00 00 c0 ee    	add    $0xeec00000,%edx
  801040:	8b 52 50             	mov    0x50(%edx),%edx
  801043:	39 ca                	cmp    %ecx,%edx
  801045:	75 14                	jne    80105b <ipc_find_env+0x37>
  801047:	eb 05                	jmp    80104e <ipc_find_env+0x2a>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  80104e:	6b c0 7c             	imul   $0x7c,%eax,%eax
  801051:	05 08 00 c0 ee       	add    $0xeec00008,%eax
  801056:	8b 40 40             	mov    0x40(%eax),%eax
  801059:	eb 0e                	jmp    801069 <ipc_find_env+0x45>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  80105e:	3d 00 04 00 00       	cmp    $0x400,%eax
  801063:	75 d2                	jne    801037 <ipc_find_env+0x13>
		if (envs[i].env_type == type)
			return envs[i].env_id;
	return 0;
  801065:	66 b8 00 00          	mov    $0x0,%ax
}
  801069:	5d                   	pop    %ebp
  80106a:	c3                   	ret    
	...
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801071:	83 ec 20             	sub    $0x20,%esp
	...
	va_start(ap, fmt);
  801074:	8d 75 14             	lea    0x14(%ebp),%esi

	// Print the panic message
	cprintf("[%08x] user panic in %s at %s:%d: ",
  801077:	8b 1d 00 20 80 00    	mov    0x802000,%ebx
  80107d:	e8 46 fc ff ff       	call   800cc8 <sys_getenvid>
  801082:	8b 55 0c             	mov    0xc(%ebp),%edx
  801085:	89 54 24 10          	mov    %edx,0x10(%esp)
  801089:	8b 55 08             	mov    0x8(%ebp),%edx
  80108c:	89 54 24 0c          	mov    %edx,0xc(%esp)
  801090:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  801094:	89 44 24 04          	mov    %eax,0x4(%esp)
  801098:	c7 04 24 4c 16 80 00 	movl   $0x80164c,(%esp)
  80109f:	e8 5b f1 ff ff       	call   8001ff <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  8010a4:	89 74 24 04          	mov    %esi,0x4(%esp)
  8010a8:	8b 45 10             	mov    0x10(%ebp),%eax
  8010ab:	89 04 24             	mov    %eax,(%esp)
  8010ae:	e8 eb f0 ff ff       	call   80019e <vcprintf>
	cprintf("\n");
  8010b3:	c7 04 24 67 13 80 00 	movl   $0x801367,(%esp)
  8010ba:	e8 40 f1 ff ff       	call   8001ff <cprintf>

	// Cause a breakpoint exception
	while (1)
		asm volatile("int3");
  8010bf:	cc                   	int3   
  8010c0:	eb fd                	jmp    8010bf <_panic+0x53>
	...
...
008010d0 <__udivdi3>:
  ...
  8010ef:	75 2f                	jne    801120 <__udivdi3+0x50>
  8010f1:	39 f9                	cmp    %edi,%ecx
  8010f3:	77 5b                	ja     801150 <__udivdi3+0x80>
  8010f5:	85 c9                	test   %ecx,%ecx
  8010f7:	75 0b                	jne    801104 <__udivdi3+0x34>
  8010f9:	b8 01 00 00 00       	mov    $0x1,%eax
  8010fe:	31 d2                	xor    %edx,%edx
  801100:	f7 f1                	div    %ecx
  ...
  801124:	39 fe                	cmp    %edi,%esi
  801126:	77 eb                	ja     801113 <__udivdi3+0x43>
  801128:	0f bd d6             	bsr    %esi,%edx
  80112b:	83 f2 1f             	xor    $0x1f,%edx
  80112e:	89 55 f4             	mov    %edx,-0xc(%ebp)
  801131:	75 2d                	jne    801160 <__udivdi3+0x90>
  801133:	8b 4d ec             	mov    -0x14(%ebp),%ecx
  801136:	39 4d f0             	cmp    %ecx,-0x10(%ebp)
  801139:	76 06                	jbe    801141 <__udivdi3+0x71>
  80113b:	39 fe                	cmp    %edi,%esi
  80113d:	89 c2                	mov    %eax,%edx
  80113f:	73 d2                	jae    801113 <__udivdi3+0x43>
  801141:	31 d2                	xor    %edx,%edx
  801143:	b8 01 00 00 00       	mov    $0x1,%eax
  801148:	eb c9                	jmp    801113 <__udivdi3+0x43>
  80114a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  801150:	89 fa                	mov    %edi,%edx
  ...
  801160:	0f b6 4d f4          	movzbl -0xc(%ebp),%ecx
  801164:	b8 20 00 00 00       	mov    $0x20,%eax
  801169:	8b 55 f0             	mov    -0x10(%ebp),%edx
  80116c:	2b 45 f4             	sub    -0xc(%ebp),%eax
  80116f:	d3 e6                	shl    %cl,%esi
  801171:	89 c1                	mov    %eax,%ecx
  801173:	d3 ea                	shr    %cl,%edx
  801175:	0f b6 4d f4          	movzbl -0xc(%ebp),%ecx
  801179:	09 f2                	or     %esi,%edx
  80117b:	8b 75 ec             	mov    -0x14(%ebp),%esi
  80117e:	89 55 e8             	mov    %edx,-0x18(%ebp)
  801181:	8b 55 f0             	mov    -0x10(%ebp),%edx
  801184:	d3 e2                	shl    %cl,%edx
  801186:	89 c1                	mov    %eax,%ecx
  801188:	89 55 f0             	mov    %edx,-0x10(%ebp)
  80118b:	89 fa                	mov    %edi,%edx
  80118d:	d3 ea                	shr    %cl,%edx
  80118f:	0f b6 4d f4          	movzbl -0xc(%ebp),%ecx
  801193:	d3 e7                	shl    %cl,%edi
  801195:	89 c1                	mov    %eax,%ecx
  801197:	d3 ee                	shr    %cl,%esi
  801199:	09 fe                	or     %edi,%esi
  80119b:	89 f0                	mov    %esi,%eax
  80119d:	f7 75 e8             	divl   -0x18(%ebp)
  8011a0:	89 d7                	mov    %edx,%edi
  8011a2:	89 c6                	mov    %eax,%esi
  8011a4:	f7 65 f0             	mull   -0x10(%ebp)
  8011a7:	39 d7                	cmp    %edx,%edi
  8011a9:	89 55 f0             	mov    %edx,-0x10(%ebp)
  8011ac:	72 22                	jb     8011d0 <__udivdi3+0x100>
  8011ae:	8b 55 ec             	mov    -0x14(%ebp),%edx
  8011b1:	0f b6 4d f4          	movzbl -0xc(%ebp),%ecx
  8011b5:	d3 e2                	shl    %cl,%edx
  8011b7:	39 c2                	cmp    %eax,%edx
  8011b9:	73 05                	jae    8011c0 <__udivdi3+0xf0>
  8011bb:	3b 7d f0             	cmp    -0x10(%ebp),%edi
  8011be:	74 10                	je     8011d0 <__udivdi3+0x100>
  8011c0:	89 f0                	mov    %esi,%eax
  8011c2:	31 d2                	xor    %edx,%edx
  8011c4:	e9 4a ff ff ff       	jmp    801113 <__udivdi3+0x43>
...
008011e0 <__umoddi3>:
  ...
  80121a:	77 4c                	ja     801268 <__umoddi3+0x88>
  80121c:	0f bd c7             	bsr    %edi,%eax
  80121f:	83 f0 1f             	xor    $0x1f,%eax
  801222:	89 45 ec             	mov    %eax,-0x14(%ebp)
  801225:	75 51                	jne    801278 <__umoddi3+0x98>
  801227:	3b 4d f0             	cmp    -0x10(%ebp),%ecx
  80122a:	0f 87 e8 00 00 00    	ja     801318 <__umoddi3+0x138>
  801230:	89 f2                	mov    %esi,%edx
  801232:	8b 75 f0             	mov    -0x10(%ebp),%esi
  801235:	29 ce                	sub    %ecx,%esi
  801237:	19 fa                	sbb    %edi,%edx
  801239:	89 75 f0             	mov    %esi,-0x10(%ebp)
  ...
  801248:	85 c9                	test   %ecx,%ecx
  80124a:	75 0b                	jne    801257 <__umoddi3+0x77>
  80124c:	b8 01 00 00 00       	mov    $0x1,%eax
  ...
  801260:	eb a5                	jmp    801207 <__umoddi3+0x27>
  ...
  801278:	0f b6 4d ec          	movzbl -0x14(%ebp),%ecx
  80127c:	89 f2                	mov    %esi,%edx
  80127e:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801281:	c7 45 f0 20 00 00 00 	movl   $0x20,-0x10(%ebp)
  801288:	29 45 f0             	sub    %eax,-0x10(%ebp)
  80128b:	d3 e7                	shl    %cl,%edi
  80128d:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801290:	0f b6 4d f0          	movzbl -0x10(%ebp),%ecx
  801294:	d3 e8                	shr    %cl,%eax
  801296:	0f b6 4d ec          	movzbl -0x14(%ebp),%ecx
  80129a:	09 f8                	or     %edi,%eax
  80129c:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  80129f:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8012a2:	d3 e0                	shl    %cl,%eax
  8012a4:	0f b6 4d f0          	movzbl -0x10(%ebp),%ecx
  8012a8:	89 45 f4             	mov    %eax,-0xc(%ebp)
  8012ab:	8b 45 e8             	mov    -0x18(%ebp),%eax
  8012ae:	d3 ea                	shr    %cl,%edx
  8012b0:	0f b6 4d ec          	movzbl -0x14(%ebp),%ecx
  8012b4:	d3 e6                	shl    %cl,%esi
  8012b6:	0f b6 4d f0          	movzbl -0x10(%ebp),%ecx
  8012ba:	d3 e8                	shr    %cl,%eax
  8012bc:	0f b6 4d ec          	movzbl -0x14(%ebp),%ecx
  8012c0:	09 f0                	or     %esi,%eax
  8012c2:	8b 75 e8             	mov    -0x18(%ebp),%esi
  8012c5:	f7 75 e4             	divl   -0x1c(%ebp)
  8012c8:	d3 e6                	shl    %cl,%esi
  8012ca:	89 75 e8             	mov    %esi,-0x18(%ebp)
  8012cd:	89 d6                	mov    %edx,%esi
  8012cf:	f7 65 f4             	mull   -0xc(%ebp)
  8012d2:	89 d7                	mov    %edx,%edi
  8012d4:	89 c2                	mov    %eax,%edx
  8012d6:	39 fe                	cmp    %edi,%esi
  8012d8:	89 f9                	mov    %edi,%ecx
  8012da:	72 30                	jb     80130c <__umoddi3+0x12c>
  8012dc:	39 45 e8             	cmp    %eax,-0x18(%ebp)
  8012df:	72 27                	jb     801308 <__umoddi3+0x128>
  8012e1:	8b 45 e8             	mov    -0x18(%ebp),%eax
  8012e4:	29 d0                	sub    %edx,%eax
  8012e6:	19 ce                	sbb    %ecx,%esi
  8012e8:	0f b6 4d ec          	movzbl -0x14(%ebp),%ecx
  8012ec:	89 f2                	mov    %esi,%edx
  8012ee:	d3 e8                	shr    %cl,%eax
  8012f0:	0f b6 4d f0          	movzbl -0x10(%ebp),%ecx
  8012f4:	d3 e2                	shl    %cl,%edx
  8012f6:	0f b6 4d ec          	movzbl -0x14(%ebp),%ecx
  8012fa:	09 d0                	or     %edx,%eax
  ...
  801306:	c3                   	ret    
  801307:	90                   	nop
  801308:	39 fe                	cmp    %edi,%esi
  80130a:	75 d5                	jne    8012e1 <__umoddi3+0x101>
  80130c:	89 f9                	mov    %edi,%ecx
  80130e:	89 c2                	mov    %eax,%edx
  801310:	2b 55 f4             	sub    -0xc(%ebp),%edx
  801313:	1b 4d e4             	sbb    -0x1c(%ebp),%ecx
  801316:	eb c9                	jmp    8012e1 <__umoddi3+0x101>
  801318:	39 f7                	cmp    %esi,%edi
  80131a:	0f 82 10 ff ff ff    	jb     801230 <__umoddi3+0x50>
  801320:	e9 17 ff ff ff       	jmp    80123c <__umoddi3+0x5c>

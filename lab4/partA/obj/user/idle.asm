...
umain(int argc, char **argv)
{
  ...
  800037:	83 ec 08             	sub    $0x8,%esp
	binaryname = "idle";
  80003a:	c7 05 00 20 80 00 c0 	movl   $0x8011c0,0x802000
  800041:	11 80 00 
	...
	while (1) {
		sys_yield();
  800044:	e8 5f 01 00 00       	call   8001a8 <sys_yield>
...
exit(void)
{
  ...
  8000a9:	e8 69 00 00 00       	call   800117 <sys_env_destroy>
}
  8000ae:	c9                   	leave  
  8000af:	c3                   	ret    
...
sys_cgetc(void)
{
  ...
  8000f0:	89 7c 24 08          	mov    %edi,0x8(%esp)
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
...
sys_env_destroy(envid_t envid)
{
  ...
  80014a:	00 
  80014b:	c7 44 24 08 cf 11 80 	movl   $0x8011cf,0x8(%esp)
  800152:	00 
  800153:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80015a:	00 
  80015b:	c7 04 24 ec 11 80 00 	movl   $0x8011ec,(%esp)
  800162:	e8 e1 02 00 00       	call   800448 <_panic>
...
sys_getenvid(void)
{
  ...
  80017d:	89 74 24 04          	mov    %esi,0x4(%esp)
  800181:	89 7c 24 08          	mov    %edi,0x8(%esp)
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
  ...
  80018a:	b8 02 00 00 00       	mov    $0x2,%eax
...
sys_getenvid(void)
{
  ...
  800199:	8b 1c 24             	mov    (%esp),%ebx
  80019c:	8b 74 24 04          	mov    0x4(%esp),%esi
  8001a0:	8b 7c 24 08          	mov    0x8(%esp),%edi
...
sys_yield(void)
{
  ...
  8001be:	b8 0a 00 00 00       	mov    $0xa,%eax
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800211:	00 
  800212:	c7 44 24 08 cf 11 80 	movl   $0x8011cf,0x8(%esp)
  800219:	00 
  80021a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800221:	00 
  800222:	c7 04 24 ec 11 80 00 	movl   $0x8011ec,(%esp)
  800229:	e8 1a 02 00 00       	call   800448 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  80026f:	00 
  800270:	c7 44 24 08 cf 11 80 	movl   $0x8011cf,0x8(%esp)
  800277:	00 
  800278:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80027f:	00 
  800280:	c7 04 24 ec 11 80 00 	movl   $0x8011ec,(%esp)
  800287:	e8 bc 01 00 00       	call   800448 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  8002cd:	00 
  8002ce:	c7 44 24 08 cf 11 80 	movl   $0x8011cf,0x8(%esp)
  8002d5:	00 
  8002d6:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002dd:	00 
  8002de:	c7 04 24 ec 11 80 00 	movl   $0x8011ec,(%esp)
  8002e5:	e8 5e 01 00 00       	call   800448 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  80032b:	00 
  80032c:	c7 44 24 08 cf 11 80 	movl   $0x8011cf,0x8(%esp)
  800333:	00 
  800334:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80033b:	00 
  80033c:	c7 04 24 ec 11 80 00 	movl   $0x8011ec,(%esp)
  800343:	e8 00 01 00 00       	call   800448 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800389:	00 
  80038a:	c7 44 24 08 cf 11 80 	movl   $0x8011cf,0x8(%esp)
  800391:	00 
  800392:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800399:	00 
  80039a:	c7 04 24 ec 11 80 00 	movl   $0x8011ec,(%esp)
  8003a1:	e8 a2 00 00 00       	call   800448 <_panic>
...
sys_ipc_try_send(envid_t envid, uint32_t value, void *srcva, int perm)
{
  ...
  8003c0:	89 7c 24 08          	mov    %edi,0x8(%esp)
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
	...
	asm volatile("int %1\n"
  8003c4:	be 00 00 00 00       	mov    $0x0,%esi
  8003c9:	b8 0b 00 00 00       	mov    $0xb,%eax
  8003ce:	8b 7d 14             	mov    0x14(%ebp),%edi
...
sys_ipc_try_send(envid_t envid, uint32_t value, void *srcva, int perm)
{
  ...
  8003dc:	8b 1c 24             	mov    (%esp),%ebx
  8003df:	8b 74 24 04          	mov    0x4(%esp),%esi
  8003e3:	8b 7c 24 08          	mov    0x8(%esp),%edi
...
sys_ipc_recv(void *dstva)
{
  ...
  80041e:	00 
  80041f:	c7 44 24 08 cf 11 80 	movl   $0x8011cf,0x8(%esp)
  800426:	00 
  800427:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80042e:	00 
  80042f:	c7 04 24 ec 11 80 00 	movl   $0x8011ec,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80044d:	83 ec 20             	sub    $0x20,%esp
	...
	va_start(ap, fmt);
  800450:	8d 75 14             	lea    0x14(%ebp),%esi

	// Print the panic message
	cprintf("[%08x] user panic in %s at %s:%d: ",
  800453:	8b 1d 00 20 80 00    	mov    0x802000,%ebx
  800459:	e8 16 fd ff ff       	call   800174 <sys_getenvid>
  80045e:	8b 55 0c             	mov    0xc(%ebp),%edx
  800461:	89 54 24 10          	mov    %edx,0x10(%esp)
  800465:	8b 55 08             	mov    0x8(%ebp),%edx
  800468:	89 54 24 0c          	mov    %edx,0xc(%esp)
  80046c:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  800470:	89 44 24 04          	mov    %eax,0x4(%esp)
  800474:	c7 04 24 fc 11 80 00 	movl   $0x8011fc,(%esp)
  ...
  80048a:	e8 53 00 00 00       	call   8004e2 <vcprintf>
	cprintf("\n");
  80048f:	c7 04 24 20 12 80 00 	movl   $0x801220,(%esp)
  800496:	e8 a8 00 00 00       	call   800543 <cprintf>

	// Cause a breakpoint exception
	while (1)
		asm volatile("int3");
  80049b:	cc                   	int3   
  80049c:	eb fd                	jmp    80049b <_panic+0x53>
	...
...
putch(int ch, struct printbuf *b)
{
  ...
  8004a7:	8b 5d 0c             	mov    0xc(%ebp),%ebx
	b->buf[b->idx++] = ch;
  8004aa:	8b 03                	mov    (%ebx),%eax
  8004ac:	8b 55 08             	mov    0x8(%ebp),%edx
  8004af:	88 54 03 08          	mov    %dl,0x8(%ebx,%eax,1)
  8004b3:	83 c0 01             	add    $0x1,%eax
  8004b6:	89 03                	mov    %eax,(%ebx)
	if (b->idx == 256-1) {
  8004b8:	3d ff 00 00 00       	cmp    $0xff,%eax
  8004bd:	75 19                	jne    8004d8 <putch+0x38>
		sys_cputs(b->buf, b->idx);
  8004bf:	c7 44 24 04 ff 00 00 	movl   $0xff,0x4(%esp)
  8004c6:	00 
  8004c7:	8d 43 08             	lea    0x8(%ebx),%eax
  8004ca:	89 04 24             	mov    %eax,(%esp)
  8004cd:	e8 de fb ff ff       	call   8000b0 <sys_cputs>
		b->idx = 0;
  8004d2:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
	}
	b->cnt++;
  8004d8:	83 43 04 01          	addl   $0x1,0x4(%ebx)
}
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  8004e5:	81 ec 28 01 00 00    	sub    $0x128,%esp
	struct printbuf b;
  ...
  800517:	c7 04 24 a0 04 80 00 	movl   $0x8004a0,(%esp)
  80051e:	e8 de 01 00 00       	call   800701 <vprintfmt>
	sys_cputs(b.buf, b.idx);
  800523:	8b 85 f0 fe ff ff    	mov    -0x110(%ebp),%eax
  800529:	89 44 24 04          	mov    %eax,0x4(%esp)
  80052d:	8d 85 f8 fe ff ff    	lea    -0x108(%ebp),%eax
  800533:	89 04 24             	mov    %eax,(%esp)
  800536:	e8 75 fb ff ff       	call   8000b0 <sys_cputs>
...
cprintf(const char *fmt, ...)
{
  ...
  800556:	e8 87 ff ff ff       	call   8004e2 <vcprintf>
	va_end(ap);
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800633:	0f be 80 22 12 80 00 	movsbl 0x801222(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80082e:	c7 44 24 08 3a 12 80 	movl   $0x80123a,0x8(%esp)
  800835:	00 
  ...
  800851:	c7 44 24 08 43 12 80 	movl   $0x801243,0x8(%esp)
  800858:	00 
  ...
  800886:	ba 33 12 80 00       	mov    $0x801233,%edx

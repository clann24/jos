	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800253:	0f be 80 f1 11 80 00 	movsbl 0x8011f1(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8003ab:	ff 24 85 c0 12 80 00 	jmp    *0x8012c0(,%eax,4)
		case '6':
		case '7':
		case '8':
		case '9':
  ...
  800471:	c7 44 24 08 12 12 80 	movl   $0x801212,0x8(%esp)
  800478:	00 
  ...
  8004a6:	ba 02 12 80 00       	mov    $0x801202,%edx
...
sys_env_destroy(envid_t envid)
{
  ...
  800bfe:	00 
  800bff:	c7 44 24 08 44 14 80 	movl   $0x801444,0x8(%esp)
  800c06:	00 
  800c07:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c0e:	00 
  800c0f:	c7 04 24 61 14 80 00 	movl   $0x801461,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800cc5:	00 
  800cc6:	c7 44 24 08 44 14 80 	movl   $0x801444,0x8(%esp)
  800ccd:	00 
  800cce:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cd5:	00 
  800cd6:	c7 04 24 61 14 80 00 	movl   $0x801461,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800d23:	00 
  800d24:	c7 44 24 08 44 14 80 	movl   $0x801444,0x8(%esp)
  800d2b:	00 
  800d2c:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d33:	00 
  800d34:	c7 04 24 61 14 80 00 	movl   $0x801461,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800d81:	00 
  800d82:	c7 44 24 08 44 14 80 	movl   $0x801444,0x8(%esp)
  800d89:	00 
  800d8a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d91:	00 
  800d92:	c7 04 24 61 14 80 00 	movl   $0x801461,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800ddf:	00 
  800de0:	c7 44 24 08 44 14 80 	movl   $0x801444,0x8(%esp)
  800de7:	00 
  800de8:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800def:	00 
  800df0:	c7 04 24 61 14 80 00 	movl   $0x801461,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800e3d:	00 
  800e3e:	c7 44 24 08 44 14 80 	movl   $0x801444,0x8(%esp)
  800e45:	00 
  800e46:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e4d:	00 
  800e4e:	c7 04 24 61 14 80 00 	movl   $0x801461,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800ed2:	00 
  800ed3:	c7 44 24 08 44 14 80 	movl   $0x801444,0x8(%esp)
  800eda:	00 
  800edb:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ee2:	00 
  800ee3:	c7 04 24 61 14 80 00 	movl   $0x801461,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800f28:	c7 04 24 70 14 80 00 	movl   $0x801470,(%esp)
  ...
  800f3e:	e8 b7 f1 ff ff       	call   8000fa <vcprintf>
	cprintf("\n");
  800f43:	c7 04 24 94 14 80 00 	movl   $0x801494,(%esp)

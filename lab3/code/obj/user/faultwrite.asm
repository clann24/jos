...
exit(void)
{
  ...
  800089:	e8 69 00 00 00       	call   8000f7 <sys_env_destroy>
}
  80008e:	c9                   	leave  
  80008f:	c3                   	ret    
...
sys_cputs(const char *s, size_t len)
{
  ...
  80009d:	89 7c 24 08          	mov    %edi,0x8(%esp)
	//
...
sys_cputs(const char *s, size_t len)
{
  ...
  8000b4:	8b 1c 24             	mov    (%esp),%ebx
  8000b7:	8b 74 24 04          	mov    0x4(%esp),%esi
  8000bb:	8b 7c 24 08          	mov    0x8(%esp),%edi
  8000bf:	89 ec                	mov    %ebp,%esp
  8000c1:	5d                   	pop    %ebp
  8000c2:	c3                   	ret    
...
sys_cgetc(void)
{
  ...
  8000c9:	89 1c 24             	mov    %ebx,(%esp)
  8000cc:	89 74 24 04          	mov    %esi,0x4(%esp)
  8000d0:	89 7c 24 08          	mov    %edi,0x8(%esp)
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
...
sys_env_destroy(envid_t envid)
{
  ...
  80011d:	7e 28                	jle    800147 <sys_env_destroy+0x50>
		panic("syscall %d returned %d (> 0)", num, ret);
  80011f:	89 44 24 10          	mov    %eax,0x10(%esp)
  800123:	c7 44 24 0c 03 00 00 	movl   $0x3,0xc(%esp)
  80012a:	00 
  80012b:	c7 44 24 08 f2 0e 80 	movl   $0x800ef2,0x8(%esp)
  800132:	00 
  800133:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80013a:	00 
  80013b:	c7 04 24 0f 0f 80 00 	movl   $0x800f0f,(%esp)
  800142:	e8 41 00 00 00       	call   800188 <_panic>
...
sys_env_destroy(envid_t envid)
{
  ...
  800147:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  80014a:	8b 75 f8             	mov    -0x8(%ebp),%esi
  80014d:	8b 7d fc             	mov    -0x4(%ebp),%edi
  800150:	89 ec                	mov    %ebp,%esp
  800152:	5d                   	pop    %ebp
  800153:	c3                   	ret    
...
sys_getenvid(void)
{
  ...
  80015d:	89 74 24 04          	mov    %esi,0x4(%esp)
  800161:	89 7c 24 08          	mov    %edi,0x8(%esp)
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
...
sys_getenvid(void)
{
  ...
  80017c:	8b 74 24 04          	mov    0x4(%esp),%esi
  800180:	8b 7c 24 08          	mov    0x8(%esp),%edi
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800199:	e8 b6 ff ff ff       	call   800154 <sys_getenvid>
  ...
  8001b4:	c7 04 24 20 0f 80 00 	movl   $0x800f20,(%esp)
  ...
  8001ca:	e8 53 00 00 00       	call   800222 <vcprintf>
	cprintf("\n");
  8001cf:	c7 04 24 44 0f 80 00 	movl   $0x800f44,(%esp)
...
putch(int ch, struct printbuf *b)
{
  ...
  80020d:	e8 7e fe ff ff       	call   800090 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  80025e:	e8 de 01 00 00       	call   800441 <vprintfmt>
	sys_cputs(b.buf, b.idx);
  ...
  800276:	e8 15 fe ff ff       	call   800090 <sys_cputs>

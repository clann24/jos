...
exit(void)
{
  ...
  800095:	e8 69 00 00 00       	call   800103 <sys_env_destroy>
}
  80009a:	c9                   	leave  
  80009b:	c3                   	ret    
...
sys_cputs(const char *s, size_t len)
{
  ...
  8000a9:	89 7c 24 08          	mov    %edi,0x8(%esp)
	//
...
sys_cputs(const char *s, size_t len)
{
  ...
  8000c3:	8b 74 24 04          	mov    0x4(%esp),%esi
  8000c7:	8b 7c 24 08          	mov    0x8(%esp),%edi
...
sys_cgetc(void)
{
  ...
  8000dc:	89 7c 24 08          	mov    %edi,0x8(%esp)
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
...
sys_env_destroy(envid_t envid)
{
  ...
  800136:	00 
  800137:	c7 44 24 08 02 0f 80 	movl   $0x800f02,0x8(%esp)
  80013e:	00 
  80013f:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800146:	00 
  800147:	c7 04 24 1f 0f 80 00 	movl   $0x800f1f,(%esp)
  80014e:	e8 41 00 00 00       	call   800194 <_panic>
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8001a5:	e8 b6 ff ff ff       	call   800160 <sys_getenvid>
  ...
  8001c0:	c7 04 24 30 0f 80 00 	movl   $0x800f30,(%esp)
  ...
  8001d6:	e8 53 00 00 00       	call   80022e <vcprintf>
	cprintf("\n");
  8001db:	c7 04 24 54 0f 80 00 	movl   $0x800f54,(%esp)
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  80026a:	e8 e2 01 00 00       	call   800451 <vprintfmt>
	sys_cputs(b.buf, b.idx);
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800383:	0f be 80 56 0f 80 00 	movsbl 0x800f56(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800461:	75 12                	jne    800475 <vprintfmt+0x24>
				csa = 0x0700;
  800463:	c7 05 08 20 80 00 00 	movl   $0x700,0x802008
  80046a:	07 00 00 
			for (fmt--; fmt[-1] != '%'; fmt--)
				/* do nothing */;
			break;
  ...
  8004db:	ff 24 85 e4 0f 80 00 	jmp    *0x800fe4(,%eax,4)
		case '6':
		case '7':
		case '8':
		case '9':
  ...
  8005a1:	c7 44 24 08 77 0f 80 	movl   $0x800f77,0x8(%esp)
  8005a8:	00 
  ...
  8005d6:	ba 67 0f 80 00       	mov    $0x800f67,%edx

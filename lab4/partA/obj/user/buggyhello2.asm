...
exit(void)
{
  ...
  8000b1:	e8 69 00 00 00       	call   80011f <sys_env_destroy>
}
  8000b6:	c9                   	leave  
  8000b7:	c3                   	ret    
...
sys_cgetc(void)
{
  ...
  8000f8:	89 7c 24 08          	mov    %edi,0x8(%esp)
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
...
sys_env_destroy(envid_t envid)
{
  ...
  800152:	00 
  800153:	c7 44 24 08 d8 11 80 	movl   $0x8011d8,0x8(%esp)
  80015a:	00 
  80015b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800162:	00 
  800163:	c7 04 24 f5 11 80 00 	movl   $0x8011f5,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800219:	00 
  80021a:	c7 44 24 08 d8 11 80 	movl   $0x8011d8,0x8(%esp)
  800221:	00 
  800222:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800229:	00 
  80022a:	c7 04 24 f5 11 80 00 	movl   $0x8011f5,(%esp)
  800231:	e8 1a 02 00 00       	call   800450 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800277:	00 
  800278:	c7 44 24 08 d8 11 80 	movl   $0x8011d8,0x8(%esp)
  80027f:	00 
  800280:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800287:	00 
  800288:	c7 04 24 f5 11 80 00 	movl   $0x8011f5,(%esp)
  80028f:	e8 bc 01 00 00       	call   800450 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  8002d5:	00 
  8002d6:	c7 44 24 08 d8 11 80 	movl   $0x8011d8,0x8(%esp)
  8002dd:	00 
  8002de:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002e5:	00 
  8002e6:	c7 04 24 f5 11 80 00 	movl   $0x8011f5,(%esp)
  8002ed:	e8 5e 01 00 00       	call   800450 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800333:	00 
  800334:	c7 44 24 08 d8 11 80 	movl   $0x8011d8,0x8(%esp)
  80033b:	00 
  80033c:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800343:	00 
  800344:	c7 04 24 f5 11 80 00 	movl   $0x8011f5,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800391:	00 
  800392:	c7 44 24 08 d8 11 80 	movl   $0x8011d8,0x8(%esp)
  800399:	00 
  80039a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8003a1:	00 
  8003a2:	c7 04 24 f5 11 80 00 	movl   $0x8011f5,(%esp)
  8003a9:	e8 a2 00 00 00       	call   800450 <_panic>
...
sys_ipc_try_send(envid_t envid, uint32_t value, void *srcva, int perm)
{
  ...
  8003c1:	89 1c 24             	mov    %ebx,(%esp)
  8003c4:	89 74 24 04          	mov    %esi,0x4(%esp)
  8003c8:	89 7c 24 08          	mov    %edi,0x8(%esp)
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
  ...
  8003d1:	b8 0b 00 00 00       	mov    $0xb,%eax
  8003d6:	8b 7d 14             	mov    0x14(%ebp),%edi
...
sys_ipc_try_send(envid_t envid, uint32_t value, void *srcva, int perm)
{
  ...
  8003e4:	8b 1c 24             	mov    (%esp),%ebx
  8003e7:	8b 74 24 04          	mov    0x4(%esp),%esi
  8003eb:	8b 7c 24 08          	mov    0x8(%esp),%edi
...
sys_ipc_recv(void *dstva)
{
  ...
  800426:	00 
  800427:	c7 44 24 08 d8 11 80 	movl   $0x8011d8,0x8(%esp)
  80042e:	00 
  80042f:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800436:	00 
  800437:	c7 04 24 f5 11 80 00 	movl   $0x8011f5,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80045b:	8b 1d 04 20 80 00    	mov    0x802004,%ebx
  ...
  80047c:	c7 04 24 04 12 80 00 	movl   $0x801204,(%esp)
  ...
  800492:	e8 53 00 00 00       	call   8004ea <vcprintf>
	cprintf("\n");
  800497:	c7 04 24 cc 11 80 00 	movl   $0x8011cc,(%esp)
...
putch(int ch, struct printbuf *b)
{
  ...
  8004d5:	e8 de fb ff ff       	call   8000b8 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  800526:	e8 e6 01 00 00       	call   800711 <vprintfmt>
	sys_cputs(b.buf, b.idx);
  ...
  80053e:	e8 75 fb ff ff       	call   8000b8 <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800643:	0f be 80 28 12 80 00 	movsbl 0x801228(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800721:	75 12                	jne    800735 <vprintfmt+0x24>
				csa = 0x0700;
  800723:	c7 05 0c 20 80 00 00 	movl   $0x700,0x80200c
  80072a:	07 00 00 
			for (fmt--; fmt[-1] != '%'; fmt--)
				/* do nothing */;
			break;
  ...
  80083e:	c7 44 24 08 40 12 80 	movl   $0x801240,0x8(%esp)
  800845:	00 
  ...
  800861:	c7 44 24 08 49 12 80 	movl   $0x801249,0x8(%esp)
  800868:	00 
  ...
  800896:	ba 39 12 80 00       	mov    $0x801239,%edx
  ...
  800a76:	e8 17 fc ff ff       	call   800692 <getint>
			csa = num;
  800a7b:	a3 0c 20 80 00       	mov    %eax,0x80200c
			break;

...
exit(void)
{
  ...
  800085:	e8 69 00 00 00       	call   8000f3 <sys_env_destroy>
}
  80008a:	c9                   	leave  
  80008b:	c3                   	ret    
...
sys_cputs(const char *s, size_t len)
{
  ...
  800099:	89 7c 24 08          	mov    %edi,0x8(%esp)
	//
...
sys_cputs(const char *s, size_t len)
{
  ...
  8000b0:	8b 1c 24             	mov    (%esp),%ebx
  8000b3:	8b 74 24 04          	mov    0x4(%esp),%esi
  8000b7:	8b 7c 24 08          	mov    0x8(%esp),%edi
...
sys_cgetc(void)
{
  ...
  8000cc:	89 7c 24 08          	mov    %edi,0x8(%esp)
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
...
sys_env_destroy(envid_t envid)
{
  ...
  800119:	7e 28                	jle    800143 <sys_env_destroy+0x50>
		panic("syscall %d returned %d (> 0)", num, ret);
  80011b:	89 44 24 10          	mov    %eax,0x10(%esp)
  80011f:	c7 44 24 0c 03 00 00 	movl   $0x3,0xc(%esp)
  800126:	00 
  800127:	c7 44 24 08 f2 0e 80 	movl   $0x800ef2,0x8(%esp)
  80012e:	00 
  80012f:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800136:	00 
  800137:	c7 04 24 0f 0f 80 00 	movl   $0x800f0f,(%esp)
  80013e:	e8 41 00 00 00       	call   800184 <_panic>
...
sys_env_destroy(envid_t envid)
{
  ...
  800143:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  800146:	8b 75 f8             	mov    -0x8(%ebp),%esi
  800149:	8b 7d fc             	mov    -0x4(%ebp),%edi
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800195:	e8 b6 ff ff ff       	call   800150 <sys_getenvid>
  ...
  8001b0:	c7 04 24 20 0f 80 00 	movl   $0x800f20,(%esp)
  ...
  8001c6:	e8 53 00 00 00       	call   80021e <vcprintf>
	cprintf("\n");
  8001cb:	c7 04 24 44 0f 80 00 	movl   $0x800f44,(%esp)

...
umain(int argc, char **argv)
{
  ...
  800047:	c7 04 24 80 12 80 00 	movl   $0x801280,(%esp)
  80004e:	e8 74 01 00 00       	call   8001c7 <cprintf>
	if ((env = fork()) == 0) {
  800053:	e8 14 0f 00 00       	call   800f6c <fork>
  800058:	89 c3                	mov    %eax,%ebx
  80005a:	85 c0                	test   %eax,%eax
  80005c:	75 0e                	jne    80006c <umain+0x2c>
		cprintf("I am the child.  Spinning...\n");
  80005e:	c7 04 24 f8 12 80 00 	movl   $0x8012f8,(%esp)
  ...
  80006c:	c7 04 24 a8 12 80 00 	movl   $0x8012a8,(%esp)
  800073:	e8 4f 01 00 00       	call   8001c7 <cprintf>
	sys_yield();
  800078:	e8 4f 0c 00 00       	call   800ccc <sys_yield>
	sys_yield();
  80007d:	e8 4a 0c 00 00       	call   800ccc <sys_yield>
	sys_yield();
  800082:	e8 45 0c 00 00       	call   800ccc <sys_yield>
	sys_yield();
  800087:	e8 40 0c 00 00       	call   800ccc <sys_yield>
	sys_yield();
  80008c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  800090:	e8 37 0c 00 00       	call   800ccc <sys_yield>
	sys_yield();
  800095:	e8 32 0c 00 00       	call   800ccc <sys_yield>
	sys_yield();
  80009a:	e8 2d 0c 00 00       	call   800ccc <sys_yield>
	sys_yield();
  80009f:	90                   	nop
  8000a0:	e8 27 0c 00 00       	call   800ccc <sys_yield>

	cprintf("I am the parent.  Killing the child...\n");
  8000a5:	c7 04 24 d0 12 80 00 	movl   $0x8012d0,(%esp)
  8000ac:	e8 16 01 00 00       	call   8001c7 <cprintf>
	sys_env_destroy(env);
  8000b1:	89 1c 24             	mov    %ebx,(%esp)
  8000b4:	e8 82 0b 00 00       	call   800c3b <sys_env_destroy>
}
...
libmain(int argc, char **argv)
{
  ...
  8000d2:	e8 c1 0b 00 00       	call   800c98 <sys_getenvid>
...
exit(void)
{
  ...
  80011d:	e8 19 0b 00 00       	call   800c3b <sys_env_destroy>
}
  800122:	c9                   	leave  
  800123:	c3                   	ret    
...
putch(int ch, struct printbuf *b)
{
  ...
  800151:	e8 7e 0a 00 00       	call   800bd4 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  8001a2:	e8 ea 01 00 00       	call   800391 <vprintfmt>
	sys_cputs(b.buf, b.idx);
  ...
  8001ba:	e8 15 0a 00 00       	call   800bd4 <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80025f:	e8 ac 0d 00 00       	call   801010 <__udivdi3>
  ...
  8002ba:	e8 61 0e 00 00       	call   801120 <__umoddi3>
  8002bf:	89 74 24 04          	mov    %esi,0x4(%esp)
  8002c3:	0f be 80 20 13 80 00 	movsbl 0x801320(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80041b:	ff 24 85 e0 13 80 00 	jmp    *0x8013e0(,%eax,4)
		case '6':
		case '7':
		case '8':
		case '9':
  ...
  8004e1:	c7 44 24 08 41 13 80 	movl   $0x801341,0x8(%esp)
  8004e8:	00 
  ...
  800516:	ba 31 13 80 00       	mov    $0x801331,%edx
...
sys_env_destroy(envid_t envid)
{
  ...
  800c6e:	00 
  800c6f:	c7 44 24 08 64 15 80 	movl   $0x801564,0x8(%esp)
  800c76:	00 
  800c77:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c7e:	00 
  800c7f:	c7 04 24 81 15 80 00 	movl   $0x801581,(%esp)
  800c86:	e8 25 03 00 00       	call   800fb0 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800d35:	00 
  800d36:	c7 44 24 08 64 15 80 	movl   $0x801564,0x8(%esp)
  800d3d:	00 
  800d3e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d45:	00 
  800d46:	c7 04 24 81 15 80 00 	movl   $0x801581,(%esp)
  800d4d:	e8 5e 02 00 00       	call   800fb0 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800d93:	00 
  800d94:	c7 44 24 08 64 15 80 	movl   $0x801564,0x8(%esp)
  800d9b:	00 
  800d9c:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800da3:	00 
  800da4:	c7 04 24 81 15 80 00 	movl   $0x801581,(%esp)
  800dab:	e8 00 02 00 00       	call   800fb0 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800df1:	00 
  800df2:	c7 44 24 08 64 15 80 	movl   $0x801564,0x8(%esp)
  800df9:	00 
  800dfa:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e01:	00 
  800e02:	c7 04 24 81 15 80 00 	movl   $0x801581,(%esp)
  800e09:	e8 a2 01 00 00       	call   800fb0 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800e4f:	00 
  800e50:	c7 44 24 08 64 15 80 	movl   $0x801564,0x8(%esp)
  800e57:	00 
  800e58:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e5f:	00 
  800e60:	c7 04 24 81 15 80 00 	movl   $0x801581,(%esp)
  800e67:	e8 44 01 00 00       	call   800fb0 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800ead:	00 
  800eae:	c7 44 24 08 64 15 80 	movl   $0x801564,0x8(%esp)
  800eb5:	00 
  800eb6:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ebd:	00 
  800ebe:	c7 04 24 81 15 80 00 	movl   $0x801581,(%esp)
  800ec5:	e8 e6 00 00 00       	call   800fb0 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800f42:	00 
  800f43:	c7 44 24 08 64 15 80 	movl   $0x801564,0x8(%esp)
  800f4a:	00 
  800f4b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800f52:	00 
  800f53:	c7 04 24 81 15 80 00 	movl   $0x801581,(%esp)
  800f5a:	e8 51 00 00 00       	call   800fb0 <_panic>
...
fork(void)
{
  ...
  800f72:	c7 44 24 08 9b 15 80 	movl   $0x80159b,0x8(%esp)
  800f79:	00 
  800f7a:	c7 44 24 04 52 00 00 	movl   $0x52,0x4(%esp)
  800f81:	00 
  800f82:	c7 04 24 8f 15 80 00 	movl   $0x80158f,(%esp)
  800f89:	e8 22 00 00 00       	call   800fb0 <_panic>
...
sfork(void)
{
  ...
  800f94:	c7 44 24 08 9a 15 80 	movl   $0x80159a,0x8(%esp)
  800f9b:	00 
  800f9c:	c7 44 24 04 59 00 00 	movl   $0x59,0x4(%esp)
  800fa3:	00 
  800fa4:	c7 04 24 8f 15 80 00 	movl   $0x80158f,(%esp)
  800fab:	e8 00 00 00 00       	call   800fb0 <_panic>
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800fb5:	83 ec 20             	sub    $0x20,%esp
	...
	va_start(ap, fmt);
  800fb8:	8d 75 14             	lea    0x14(%ebp),%esi

	// Print the panic message
	cprintf("[%08x] user panic in %s at %s:%d: ",
  800fbb:	8b 1d 00 20 80 00    	mov    0x802000,%ebx
  800fc1:	e8 d2 fc ff ff       	call   800c98 <sys_getenvid>
  800fc6:	8b 55 0c             	mov    0xc(%ebp),%edx
  800fc9:	89 54 24 10          	mov    %edx,0x10(%esp)
  800fcd:	8b 55 08             	mov    0x8(%ebp),%edx
  800fd0:	89 54 24 0c          	mov    %edx,0xc(%esp)
  800fd4:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  800fd8:	89 44 24 04          	mov    %eax,0x4(%esp)
  800fdc:	c7 04 24 b0 15 80 00 	movl   $0x8015b0,(%esp)
  800fe3:	e8 df f1 ff ff       	call   8001c7 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800fe8:	89 74 24 04          	mov    %esi,0x4(%esp)
  800fec:	8b 45 10             	mov    0x10(%ebp),%eax
  800fef:	89 04 24             	mov    %eax,(%esp)
  800ff2:	e8 6f f1 ff ff       	call   800166 <vcprintf>
	cprintf("\n");
  800ff7:	c7 04 24 14 13 80 00 	movl   $0x801314,(%esp)
  800ffe:	e8 c4 f1 ff ff       	call   8001c7 <cprintf>

	// Cause a breakpoint exception
	while (1)
		asm volatile("int3");
  801003:	cc                   	int3   
  801004:	eb fd                	jmp    801003 <_panic+0x53>
	...
...
00801010 <__udivdi3>:
  ...
  801018:	8b 75 14             	mov    0x14(%ebp),%esi
  ...
  801029:	89 4d f0             	mov    %ecx,-0x10(%ebp)
  80102c:	89 45 f4             	mov    %eax,-0xc(%ebp)
  80102f:	75 2f                	jne    801060 <__udivdi3+0x50>
  801031:	39 f9                	cmp    %edi,%ecx
  801033:	77 5b                	ja     801090 <__udivdi3+0x80>
  801035:	85 c9                	test   %ecx,%ecx
  801037:	75 0b                	jne    801044 <__udivdi3+0x34>
  801039:	b8 01 00 00 00       	mov    $0x1,%eax
  ...
  801064:	39 fe                	cmp    %edi,%esi
  801066:	77 eb                	ja     801053 <__udivdi3+0x43>
  801068:	0f bd d6             	bsr    %esi,%edx
  80106b:	83 f2 1f             	xor    $0x1f,%edx
  80106e:	89 55 f4             	mov    %edx,-0xc(%ebp)
  801071:	75 2d                	jne    8010a0 <__udivdi3+0x90>
  801073:	8b 4d ec             	mov    -0x14(%ebp),%ecx
  801076:	39 4d f0             	cmp    %ecx,-0x10(%ebp)
  801079:	76 06                	jbe    801081 <__udivdi3+0x71>
  80107b:	39 fe                	cmp    %edi,%esi
  80107d:	89 c2                	mov    %eax,%edx
  80107f:	73 d2                	jae    801053 <__udivdi3+0x43>
  801081:	31 d2                	xor    %edx,%edx
  801083:	b8 01 00 00 00       	mov    $0x1,%eax
  801088:	eb c9                	jmp    801053 <__udivdi3+0x43>
  80108a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  801090:	89 fa                	mov    %edi,%edx
  ...
  8010a0:	0f b6 4d f4          	movzbl -0xc(%ebp),%ecx
  8010a4:	b8 20 00 00 00       	mov    $0x20,%eax
  8010a9:	8b 55 f0             	mov    -0x10(%ebp),%edx
  8010ac:	2b 45 f4             	sub    -0xc(%ebp),%eax
  8010af:	d3 e6                	shl    %cl,%esi
  8010b1:	89 c1                	mov    %eax,%ecx
  8010b3:	d3 ea                	shr    %cl,%edx
  8010b5:	0f b6 4d f4          	movzbl -0xc(%ebp),%ecx
  8010b9:	09 f2                	or     %esi,%edx
  8010bb:	8b 75 ec             	mov    -0x14(%ebp),%esi
  8010be:	89 55 e8             	mov    %edx,-0x18(%ebp)
  8010c1:	8b 55 f0             	mov    -0x10(%ebp),%edx
  8010c4:	d3 e2                	shl    %cl,%edx
  8010c6:	89 c1                	mov    %eax,%ecx
  8010c8:	89 55 f0             	mov    %edx,-0x10(%ebp)
  8010cb:	89 fa                	mov    %edi,%edx
  8010cd:	d3 ea                	shr    %cl,%edx
  8010cf:	0f b6 4d f4          	movzbl -0xc(%ebp),%ecx
  8010d3:	d3 e7                	shl    %cl,%edi
  8010d5:	89 c1                	mov    %eax,%ecx
  8010d7:	d3 ee                	shr    %cl,%esi
  8010d9:	09 fe                	or     %edi,%esi
  8010db:	89 f0                	mov    %esi,%eax
  8010dd:	f7 75 e8             	divl   -0x18(%ebp)
  8010e0:	89 d7                	mov    %edx,%edi
  8010e2:	89 c6                	mov    %eax,%esi
  8010e4:	f7 65 f0             	mull   -0x10(%ebp)
  8010e7:	39 d7                	cmp    %edx,%edi
  8010e9:	89 55 f0             	mov    %edx,-0x10(%ebp)
  8010ec:	72 22                	jb     801110 <__udivdi3+0x100>
  8010ee:	8b 55 ec             	mov    -0x14(%ebp),%edx
  8010f1:	0f b6 4d f4          	movzbl -0xc(%ebp),%ecx
  8010f5:	d3 e2                	shl    %cl,%edx
  8010f7:	39 c2                	cmp    %eax,%edx
  8010f9:	73 05                	jae    801100 <__udivdi3+0xf0>
  8010fb:	3b 7d f0             	cmp    -0x10(%ebp),%edi
  8010fe:	74 10                	je     801110 <__udivdi3+0x100>
  801100:	89 f0                	mov    %esi,%eax
  801102:	31 d2                	xor    %edx,%edx
  801104:	e9 4a ff ff ff       	jmp    801053 <__udivdi3+0x43>
...
00801120 <__umoddi3>:
  ...
  801136:	89 45 e8             	mov    %eax,-0x18(%ebp)
  801139:	89 4d f4             	mov    %ecx,-0xc(%ebp)
  80113c:	89 45 f0             	mov    %eax,-0x10(%ebp)
  80113f:	89 f2                	mov    %esi,%edx
  801141:	75 15                	jne    801158 <__umoddi3+0x38>
  801143:	39 f1                	cmp    %esi,%ecx
  801145:	76 41                	jbe    801188 <__umoddi3+0x68>
  ...
  801158:	39 f7                	cmp    %esi,%edi
  80115a:	77 4c                	ja     8011a8 <__umoddi3+0x88>
  80115c:	0f bd c7             	bsr    %edi,%eax
  80115f:	83 f0 1f             	xor    $0x1f,%eax
  801162:	89 45 ec             	mov    %eax,-0x14(%ebp)
  801165:	75 51                	jne    8011b8 <__umoddi3+0x98>
  801167:	3b 4d f0             	cmp    -0x10(%ebp),%ecx
  80116a:	0f 87 e8 00 00 00    	ja     801258 <__umoddi3+0x138>
  801170:	89 f2                	mov    %esi,%edx
  801172:	8b 75 f0             	mov    -0x10(%ebp),%esi
  801175:	29 ce                	sub    %ecx,%esi
  801177:	19 fa                	sbb    %edi,%edx
  801179:	89 75 f0             	mov    %esi,-0x10(%ebp)
  ...
  80118a:	75 0b                	jne    801197 <__umoddi3+0x77>
  ...
  8011a0:	eb a5                	jmp    801147 <__umoddi3+0x27>
  ...
  8011fc:	0f b6 4d ec          	movzbl -0x14(%ebp),%ecx
  801200:	09 f0                	or     %esi,%eax
  801202:	8b 75 e8             	mov    -0x18(%ebp),%esi
  801205:	f7 75 e4             	divl   -0x1c(%ebp)
  801208:	d3 e6                	shl    %cl,%esi
  80120a:	89 75 e8             	mov    %esi,-0x18(%ebp)
  80120d:	89 d6                	mov    %edx,%esi
  80120f:	f7 65 f4             	mull   -0xc(%ebp)
  801212:	89 d7                	mov    %edx,%edi
  801214:	89 c2                	mov    %eax,%edx
  801216:	39 fe                	cmp    %edi,%esi
  801218:	89 f9                	mov    %edi,%ecx
  80121a:	72 30                	jb     80124c <__umoddi3+0x12c>
  80121c:	39 45 e8             	cmp    %eax,-0x18(%ebp)
  80121f:	72 27                	jb     801248 <__umoddi3+0x128>
  801221:	8b 45 e8             	mov    -0x18(%ebp),%eax
  801224:	29 d0                	sub    %edx,%eax
  801226:	19 ce                	sbb    %ecx,%esi
  801228:	0f b6 4d ec          	movzbl -0x14(%ebp),%ecx
  ...
  801246:	c3                   	ret    
  801247:	90                   	nop
  801248:	39 fe                	cmp    %edi,%esi
  80124a:	75 d5                	jne    801221 <__umoddi3+0x101>
  80124c:	89 f9                	mov    %edi,%ecx
  80124e:	89 c2                	mov    %eax,%edx
  801250:	2b 55 f4             	sub    -0xc(%ebp),%edx
  801253:	1b 4d e4             	sbb    -0x1c(%ebp),%ecx
  801256:	eb c9                	jmp    801221 <__umoddi3+0x101>
  801258:	39 f7                	cmp    %esi,%edi
  80125a:	0f 82 10 ff ff ff    	jb     801170 <__umoddi3+0x50>
  801260:	e9 17 ff ff ff       	jmp    80117c <__umoddi3+0x5c>
